...
reg2 = DW1000_readData32(0x26,0x0); // read the current GPIO_CTRL_ID register 
 reg2 |= 0x00014000; // set the appropriate GPIOs
DW1000_writeData32(0x26,0x0,reg2); // write the modified value back 
 //disable fine grain sequencing
 DW1000_writeData16(PMSC_ID, 0x26,0);
